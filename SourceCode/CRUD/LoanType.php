    ...
    <body class="sb-nav-fixed" style="overflow-y: hidden;">
        ...
        <div id="layoutSidenav">
            ...
            <?php  
                ...
                $loanType_name = $_POST['loanType_name'];
                $description = $_POST['description'];
             

            
                $query = "INSERT INTO loan_type (loanType_name,`description` ) 
                VALUES ('$loanType_name', '$description')";
                    ...
                    ?>
                                ...
                                <div class="container my-3 ">
                                  <div class="row">
                                      ...
                                      <div class="card">
                                          <div class="card-body">
                                            <h6 class="card-title py-2" >Loan Type Form</h5>
                                            <form>
                                              <div class="mb-3">
                                                <label for="loanType_name" class="form-label">Type</label>
                                                <input type="text" step="any" min="0" max="100" class="form-control text-right" name="loanType_name"  id="loanType_name" aria-label="interest">
                                              </div>
                                              <div class="mb-3">
                                                <label for="description" class="form-label">Description</label>
                                                <textarea class="form-control" id="description" name="description" aria-label="description" rows="2"></textarea>
                                              </div>
                                      ...
                                      <div class="col-md-8 justify-content-center py-2 ">
                                        <div class="div bg-light" style="max-height:520px ; overflow-y: scroll; ">
                                          <div class="table-responsive py-1 px-2">
                                            <table class="table table-bordered my-2" id="myTable">
                                              ...
                                              <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <th style="width: 30%;" class="text-center">Loan type</th>
                                           ...
                                           ?>
                                            ...
                                            <tbody>
                                                ...
                                                <td> <?php echo $row['loanType_name']; ?> </td>
