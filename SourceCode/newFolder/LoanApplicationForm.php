              ...
              <form>
                ...
                <div class="row">
                  <div class="col-md-6 mb-4 d-flex align-items-center">
                    ...
                    <div class="form-outline  w-100">
                      <input type="text" class="form-control form-control-lg" id="presentAddress" />
                      <label for="presentAddress" class="form-label">Present Address <span style="font-size: 13px; color: gray;">(Complete Address)</span></label>
                    </div>
                  ...
                  <div class="col-md-6 mb-4 d-flex align-items-center">
                    ...
                    <div class="form-outline  w-100">
                      <input type="text" class="form-control form-control-lg" id="department" />
                ...
                <div class="row">
                  <div class="col-md-6 mb-4 pb-2">
                    ...
                    <div class="form-outline">
                      ...
                      <label class="form-label" for="empStatus">Employee Status</label>
                    </div>
                  ...
                  <div class="col-md-6 mb-4 pb-2">
                    ...
                    <div class="form-outline">
                      <input type="tel" id="position" class="form-control form-control-lg" />
                ...
                <div class="row">
                  <div class="col-md-3 mb-4 pb-2">
                    ...
                    <div class="form-outline">
                      <input type="email" id="Age" class="form-control form-control-lg" />
                  ...
                  <div class="col-md-5 mb-4 pb-2">
                    ...
                    <label class="form-label select-label">Monthly Salary</label>
                  </div>
                  ...
                  <div class="col-md-4 mb-4 pb-2">
                    <div class="form-outline">
                        ...
                        <label for="dob" class="form-label">Preffered Date</label>
                        </div>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4 mb-4 pb-2">
                    <div class="form-outline">
                      <input type="tel" id="tinNumber" class="form-control form-control-lg" />
                  ...
                  <div class="col-md-4 mb-4 pb-2">
                    <div class="form-outline">
                      <input type="tel" id="contactNum" class="form-control form-control-lg" />
                      <label class="form-label" for="contactNum">Contact No.</label>
                    </div>
                  </div>
