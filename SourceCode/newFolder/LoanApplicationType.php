        ...
        <div class="col-12 col-lg-9 col-xl-9">
          <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
            <div class="card-body p-4 p-md-5">
              ...
              <h3 class="mb-4 pb-2 pb-md-0 mb-md-5" style="color: #1165AE; font-weight:700;">NMEMPC <br><span style="font-size: medium;">Please select the applicable loan you want to apply.*</span> </h3>
              
              <form>
  
              <div class="row">
                <!-- <h2 style="margin-bottom: 2%;">Membership Type<span>*</span></h2> -->
                <div class="col-lg-8 col-md-12 col-12 ps-lg-5 mt-md-2">
                    <form action="">
                        <input type="radio" name="loan_app" value="" required> Loan Application (for First-time Borrowers)<br>
                        <input type="radio" name="loan_renewal" value="" required> Loan Renewal Request (for Borrowers with previous loan transactions)<br>
                        <!--   <input type="radio" name="fav_language" value=""> Loan Re -->
                    </form>
                    <!-- <p style="text-align: justify;"><br>For any inquiries regarding your loanable amount, feel free to contact us at (0931) 212 4851 or nmempc@gmail.com, loanrestructure@nmempc.com, cashless.loan.request@nmempc.com</p> -->
                </div>
                <a href="LoanApplicationForm.php" class="btn btn-submit btn-md"  style="background-color: #1165AE; color: white; float: right; height: 4vh; width: 10%; margin-top:15%;margin-left:10%;">Next</a>
