                            ...
                            <div class="form-outline">
                                ...
                                <label class="form-check-label" for="checkbox1">
                                 I agree to the Data Privacy Content
                                        ...
                                        <!-- Back button using an anchor tag -->
                    <a href="LoanApplicationType.php" class="btn btn-back btn-md" style="background-color: #0c151d; color: white;">Back</a>
...
<!-- 
                <input class="btn btn-back btn-md" type="submit" value="Back" href="LoanApplicationType.php" style="background-color: #0c151d; color: white;" />
                <input class="btn btn-submit btn-md" type="submit" value="Submit" style="background-color: #1165AE; color: white; float: right;"> -->
                <!-- <input class="btn btn-submit btn-md" type="submit" value="Submit" style="background-color: #1165AE; color: white; float: right;" /> -->
              </form>
            </div>
