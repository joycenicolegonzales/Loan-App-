    ...
    <div class="container-fluid text-center">
        <div class="row g-4">
            <div class="col-lg-3 col-sm-6" data-aos="fade-down" data-aos-delay="150">
                <h1 class=" text-white display-4" style="font-size: 40px;">90,00+</h1>
                <h6 class=" text-uppercase mb-0 text-white mt-3">Total Assets</h6>
            </div>
            <div class="col-lg-3 col-sm-6" data-aos="fade-down" data-aos-delay="250">
                <h1 class="text-white display-4" style="font-size: 40px;">58K+</h1>
                <h6 class="text-uppercase mb-0 text-white mt-3">Loan Receivables</h6>
            </div>
            <div class="col-lg-3 col-sm-6" data-aos="fade-down" data-aos-delay="350">
                <h1 class="text-white display-4" style="font-size: 40px;">5M+</h1>
                <h6 class="text-uppercase mb-0 text-white mt-3">Equity</h6>
            </div>
            <div class="col-lg-3 col-sm-6" data-aos="fade-down" data-aos-delay="450">
                <h1 class="text-white display-4" style="font-size: 40px;">100+</h1>
                <h6 class="text-uppercase mb-0 text-white mt-3">Total Members</h6>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6 mb-4">
                    <div class="card text-center">
                        <div class="icon-box">
                            <i class="fa-sharp fa-solid fa-users icon"></i>
                        </div>
                        <div class="text1">
                            <h4>E-Membership</h4>
                ...
                <div class="col-md-4 col-sm-6 mb-4">
                    <div class="card text-center">
                        ...
                        <div class="text1">
                            <h4>Savings</h4>
                            <p> Select the savings plan that <br> best suits you. </p>
                        </div>
                    </div>
                </div>
            </div>
...
<style>
    ...
    * {
    ...
    .container .card:hover{
            background: linear-gradient(130deg, #3f30c4 0%, #8293ff 100%);
            box-shadow: none;
        }
        .container .card:hover .icon,
        .container .card:hover .text1 h4,
        .container .card:hover .text1 p{
            color: white;
    ...
    <div id="newsCarousel" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner " style=" height: 500px;">
          <div class="carousel-item news active">
            <div class="container news" style="margin-top: 5%; ">
              <div class="row">
                <div class="col">
